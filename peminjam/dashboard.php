...
<div class="flex">
    ...
    <div class="flex-1">
        ...
        <div class="bg-blue-700 h-10 flex items-center shadow-md relative">
            <p class="text-white mx-auto text-sm">Peminjam Dashboard</p>
        ...
        <main class="p-6">
            ...
            <p>Akses barang yang Anda butuhkan kapan saja, dengan proses yang simpel.</p>
            ...
            <div class="flex mt-4">
                <div class="bg-white rounded-2xl shadow-lg p-6 ml-6 border-l-4 border-green-500 hover:shadow-xl hover:scale-105 transition-transform duration-300">
                    <h3 class="text-lg font-semibold mb-2">Barang Tersedia</h3>
